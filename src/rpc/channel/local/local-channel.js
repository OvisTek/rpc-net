const LocalProxyFunction = require("./local-proxy-function");
    ...
    constructor() {
        return new Proxy(this, {
            ...
            set: (target, prop, value) => {
                if (!target[prop]) {
                    target[prop] = new LocalProxyFunction(value);

                    return true;
                }

                throw new Error("set LocalProxyFunction - function with name " + prop + "() is already defined");
            },
